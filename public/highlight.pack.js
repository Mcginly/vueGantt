...
subLanguage:"bash"}}]})})());hljs.registerLanguage("sql_more",(()=>{"use strict";return e=>{
...
},e.C_BLOCK_COMMENT_MODE,t,e.HASH_COMMENT_MODE]}}})());hljs.registerLanguage("stylus",(()=>{"use strict";return e=>{var t={
...
illegal:/\./,relevance:0}}]}}})());hljs.registerLanguage("fsharp",(()=>{"use strict";return e=>{const n={begin:"<",
...
}),e.C_NUMBER_MODE]}}})());hljs.registerLanguage("xml",(()=>{"use strict";function e(e){
...
},e.C_LINE_COMMENT_MODE,e.C_BLOCK_COMMENT_MODE]},r,s]}}})());hljs.registerLanguage("vbscript",(()=>{"use strict";function e(e){
...
subLanguage:"vbscript"}]})})());hljs.registerLanguage("markdown",(()=>{"use strict";function n(...n){
...
},e.C_NUMBER_MODE,{className:"meta",begin:"@[A-Za-z]+"},{begin:"=>"}]}}})());hljs.registerLanguage("scss",(()=>{"use strict";return e=>{var t="@[a-z-]+",i={
...
},i,e.QUOTE_STRING_MODE,e.APOS_STRING_MODE,r,e.CSS_NUMBER_MODE]}]}}})());hljs.registerLanguage("sml",(()=>{"use strict";return e=>({
...
relevance:0},{begin:/[-=]>/}]})})());hljs.registerLanguage("delphi",(()=>{"use strict";return e=>{
...
},{begin:s+":",end:":",returnBegin:!0,returnEnd:!0,relevance:0}])}}})());hljs.registerLanguage("dockerfile",(()=>{"use strict";return e=>({
name:"Dockerfile",aliases:["docker"],case_insensitive:!0,
keywords:"from maintainer expose env arg user onbuild stopsignal",
contains:[e.HASH_COMMENT_MODE,e.APOS_STRING_MODE,e.QUOTE_STRING_MODE,e.NUMBER_MODE,{
beginKeywords:"run cmd entrypoint volume add copy workdir label healthcheck shell",
starts:{end:/[^\\]$/,subLanguage:"bash"}}],illegal:"</"})})());hljs.registerLanguage("csharp",(()=>{"use strict";return e=>{var n={
...
begin:/[-+*/=%^~]|&&?|\|\|?|!=?|<(?:=>?|<|>)?|>[>=]?/,relevance:0}]}}})());hljs.registerLanguage("elm",(()=>{"use strict";return e=>{const n={
...
begin:"^[_a-z][\\w']*"}),n,{begin:"->|<-"}],illegal:/;/}}})());hljs.registerLanguage("python",(()=>{"use strict";return e=>{const n={
...
className:"number",begin:"(&[oO][0-7]{1,6})"}]})})());hljs.registerLanguage("php-template",(()=>{"use strict";return n=>({
...
name:"TypeScript",aliases:["ts"]}),b}})());hljs.registerLanguage("q",(()=>{"use strict";return e=>({name:"Q",
